...
export default function SigninPage() {
  ...
  // Slideshow state and images (same as signup page)
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-white hover:bg-green-400 hover:text-white font-medium py-2.5 px-4 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white focus:border-white disabled:opacity-50 transition-all duration-200"
                >
                  {isLoading ? (
